...
const AddUserPage = () => {
  ...
  const userstemp = [
    { username: 'amal', email: 'amal@gmail.com' },
    { username: 'thanveer', email: 'thanveer@gmail.com' },
    { username: 'hisham', email: 'hisham@gmail.com' }
  ];
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-wrap justify-center items-start flex-1 bg-gray-200 px-4 md:px-16 py-8 gap-8 overflow-hidden">
        {/* Add Button */}
        <div className="w-full md:w-1/2 lg:w-1/3 bg-white p-6 rounded-lg shadow-lg border border-none">
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 bg-white p-6 rounded-lg shadow-lg border border-none">
          ...
          <ul className="bg-white rounded-lg shadow-lg border border-none">
            {userstemp.map((user) => (
              ...
              >
                <div>
                  <p className="text-black font-medium font-mono">{user.username}</p>
